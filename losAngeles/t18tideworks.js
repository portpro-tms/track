...
const t18tideworks = async ({
  ...
  try {
    ...
    await page.goto("https://t18.tideworks.com/fc-T18/default.do").catch((err => {
    ...
    const options = {
      url: `https://t18.tideworks.com/fc-T18/import/default.do?searchBy=CTR&numbers=${containerNo}&6578706f7274=1&method=defaultSearch&d-7957256-e=1&scac=`,
      method: "GET",
      headers: {
