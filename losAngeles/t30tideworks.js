...
const t30tideworks = async ({
  ...
  try {
    ...
    await page.goto("https://t30.tideworks.com/fc-T30/default.do").catch((err => {
    ...
    const options = {
      url: `https://t30.tideworks.com/fc-T30/import/default.do?searchBy=CTR&numbers=${containerNo}&6578706f7274=1&method=defaultSearch&d-7957256-e=1&scac=`,
      method: "GET",
      headers: {
    ...
    if (body.status != 200) {
      finalData.container.caution = true;
      finalData.container.mesasge = 'Could not get container information!';
    ...
    await browser.close();
    logger.error(`L4JS ${port} and ${containerNo} ${e}`)
    finalData.container.caution = true;
