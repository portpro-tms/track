...
const everGlade = async ({
  ...
  try {
    ...
    await page.goto("https://pet.tideworks.com/fc-PET/default.do").catch((err => {
    ...
    const options = {
      url: `https://pet.tideworks.com/fc-PET/import/default.do?searchBy=CTR&numbers=${containerNo}&6578706f7274=1&method=defaultSearch&d-7957256-e=1&scac=`,
      method: "GET",
      headers: {
