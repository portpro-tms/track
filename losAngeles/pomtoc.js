...
const pmtoc = async ({
  ...
  try {
    ...
    await page.goto("https://pomtoc-online.tideworks.com/fc-POM/default.do").catch((err => {
    ...
    const options = {
      url: `https://pomtoc-online.tideworks.com/fc-POM/import/default.do?searchBy=CTR&numbers=${containerNo}&6578706f7274=1&method=defaultSearch&d-7957256-e=1&scac=`,
      method: "GET",
      headers: {
